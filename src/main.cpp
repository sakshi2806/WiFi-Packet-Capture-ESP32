...
#include "esp_private/wifi.h"  //Instead of #include "esp_wifi_internal.h" use  #include "esp_private/wifi.h"
#include "lwip/err.h"
...
void sniffer(void *buf, wifi_promiscuous_pkt_type_t type){
  ...
  // Serial.println((wifi_promiscuous_pkt_t*)buf);  
}
